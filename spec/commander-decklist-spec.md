...
- **Lower Footer Placement:** Positioned in the card's lower black margin (`y = 879..917` on a 672×936 master template). This places the badge safely within the bottom margin to clear corner radius cuts and trimming tolerances, while ensuring 100% of rules text, artist credit, and copyright information remain unobstructed.
